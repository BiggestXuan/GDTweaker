...
@ZenRegister
@ZenCodeType.Name("mods.gdtweaker.PurifierRecipe")
public class CrTPurifierRecipe implements IRecipeManager {
    @ZenCodeType.Method
    public void addRecipe(String name, IIngredient input, IItemStack output1,IItemStack output2,float xp,int time){
        PurifierRecipe recipe = new PurifierRecipe(GDTweaker.rl(name),"",input.asVanillaIngredient(),output1.getImmutableInternal(),output2.getImmutableInternal(),xp,time);
    ...
    @Override
    public IRecipeType<PurifierRecipe> getRecipeType() {
